...
if(isset($_POST['submit'])){
    ...
    if(!$firstname) {
        ...
        $_SESSION['signup'] = "Please enter your Date";
        ...
        if($createpassword !== $confirmpassword){
            ...
            if(mysqli_num_rows($user_check_result) > 0){
                $_SESSION['signup'] = "Phone Number or Email exist";
            }else {
                // WORK ON AVATAR 
                // rename avatar
                ...
                if(in_array($extention, $allowed_files)){
                    ...
                    if($avatar['size'] < 1000000) {
                        ...
                        $_SESSION['signup'] = "File size too big. Should be less than 1mn";
                    }
                } else {
    ...
    if(isset($_SESSION['signup'])){
        ...
        VALUES ('$phonenumber','$firstname', '$lastname', '$email', '$date', '$hashed_password', '$avatar_name', 0)";
