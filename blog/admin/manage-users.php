    ...
    <section class="dashboard">
        ...
        <div class="container dashboard__container">
            ...
            <aside> 
                <ul>
                    <li>
                        <a href="manage-app.php"><i class="uil uil-users-alt"></i>
            ...
            <main>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php while($user = mysqli_fetch_assoc($users)) :  ?>
                                <tr>
                                    <td><?= "{$user['name_patient']} {$user['surname_patient']}" ?></td>
                                    <td><?= $user['phone_patient'] ?></td>
                                    <td><a href="<?= ROOT_URL ?>admin/edit-user.php?phone_patient=<?= $user['phone_patient'] ?>" class="btn sm">Edit</a></td>
                                    <td><a href="<?= ROOT_URL ?>admin/delete-user.php?phone_patient=<?= $user['phone_patient'] ?>" class="btn sm danger">Delete</a></td>
                ...
                <?php else : ?>
                    <div class="alert__message"><?= "No users found" ?></div>
                <?php endif ?>
            </main>
        </div>
    </section>
